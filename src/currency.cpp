...
QString currency_code(QString name){
    ...
    static const QHash<QString,QString> aliases={
        ...
        {"litecoin","ltc"},{"litecoins","ltc"},{"solana","sol"},{"dogecoin","doge"},{"dogecoins","doge"},
        {"ripple","xrp"},{"cardano","ada"},{"binance coin","bnb"},{"bnb coin","bnb"},
        {"tether","usdt"},{"usd coin","usdc"},{"bitcoin cash","bch"},{"ethereum classic","etc"},
        {"avalanche","avax"},{"polkadot","dot"},{"chainlink","link"},
        {"stellar","xlm"},{"stellar lumen","xlm"},{"stellar lumens","xlm"},{"tron","trx"},
        {"shiba inu","shib"},{"hedera","hbar"},{"uniswap","uni"},{"cosmos","atom"},
